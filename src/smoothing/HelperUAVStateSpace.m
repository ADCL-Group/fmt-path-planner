classdef HelperUAVStateSpace < nav.StateSpace & ...
        matlabshared.planning.internal.EnforceScalarHandle
    %   Based on the ExampleHelperUAVStateSpace Class from the Motion 
    %   Planning with RRT for Fixed-Wing UAV Example from MATLAB.
    %   The HelperUAVStateSpace constructs a state space that
    ...
    methods
        function obj = HelperUAVStateSpace(varargin)
            %State Space Constructor for ExampleHelperUAVStateSpace object
            
            name = 'HelperUAVStateSpace';
            numStateVariables = 4;
            
            % Call the constructor of the base class
            obj@nav.StateSpace(name, numStateVariables, HelperUAVStateSpace.DefaultRandomStateBounds);
            ...
            if nargin ~= 0
                [mxRoll,arspeed,flightpathangle,bounds]=HelperUAVStateSpace.parseStateSpaceConstuctor(varargin{:});
    ...
    methods (Static, Access = protected)
        function [mxRoll,arspeed,flightpathangle,bnds] = parseStateSpaceConstuctor(varargin)
            ...
            p = matlabshared.autonomous.core.internal.NameValueParser({'MaxRollAngle', 'AirSpeed','FlightPathAngleLimit','Bounds'},...
                {HelperUAVStateSpace.DefaultMaxRollAngle, HelperUAVStateSpace.DefaultAirSpeed,HelperUAVStateSpace.DefaultFlightPathAngleLimit,HelperUAVStateSpace.DefaultRandomStateBounds});
            if nargin == 0
                p.parse(varargin{:});
            else
